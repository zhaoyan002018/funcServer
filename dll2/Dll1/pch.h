...
//extern "C"编译时做了什么?是告诉c++编译采用c风格的编译方式
	...
	const int funcN = 4;
	const char* myfunc[funcN] = { "addFunc","delFunc","mulFunc","divFunc" };
	const char* myfuncEx[funcN] = { "double addFunc(double a, double b)","double delFunc(double a, double b)","double mulFunc(double a, double b)","int divFunc(int a, int b)" };
	...
	__declspec(dllexport) double addFunc(double a, double b);
	__declspec(dllexport) double delFunc(double a, double b);
	__declspec(dllexport) double mulFunc(double a, double b);
	__declspec(dllexport) int divFunc(int a, int b);
